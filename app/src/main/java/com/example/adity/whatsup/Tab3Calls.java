...
public class Tab3Calls extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter=new ReAdapter(getActivity(),getData(),3);
    ...
    public static List<Item> getData(){
        ...
        String[] titles={"Iron Man","Cap America","Batman","Black Widow","Flash","Witch","Joker","Hawkeye","Wonderwoman"};
        String[] description={"Busy","Missed","Busy","Missed","Dialled",
                "Call","Dialled","Ringing","Busy"};
